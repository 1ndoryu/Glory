...
// Copied and renamed from ContentAdminPanel::render_schedule_input_control
function glory_render_schedule_input_control(string $key, array $schedule_data, string $base_input_name): void
{
...
// Copied and renamed from ContentAdminPanel::render_field_input_control
function glory_render_field_input_control(string $key, array $config, $current_value, string $option_input_name): void
{
    ...
    switch ($type) {
        ...
        case 'schedule':
            ...
            glory_render_schedule_input_control($key, is_array($current_value) ? $current_value : [], $option_input_name);
            break;
        default:
...
// Main rendering function, adapted from ContentAdminPanel::get_html_content
function render_glory_content_admin_panel_html(array $fields_by_section, string $active_tab, string $menu_slug_for_url_building): string
{
    ob_start();
?>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php glory_render_field_input_control($key, $config, $current_value_for_field, $option_input_name); // Updated call 
                                                                        ?>
                                                                        <?php if ($description): ?>
