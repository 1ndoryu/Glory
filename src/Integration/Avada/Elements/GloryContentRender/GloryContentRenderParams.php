...
class GloryContentRenderParams
{
    public static function all(): array
    {
        $params = [
            ...
            [ 'type' => 'radio_button_set', 'heading' => 'Title bold', 'param_name' => 'title_bold', 'default' => 'no', 'value' => [ 'yes' => 'Enabled', 'no' => 'Disabled' ], 'group' => 'Design' ],
            ...
            [ 'type' => 'select', 'heading' => 'LR vertical alignment', 'param_name' => 'pattern_lr_vertical_align', 'default' => 'start', 'value' => [ 'start' => 'Top', 'center' => 'Center', 'end' => 'Bottom', 'stretch' => 'Stretch' ], 'group' => 'Design', 'dependency' => [ [ 'element' => 'layout_pattern', 'value' => 'alternado_lr', 'operator' => '==' ] ] ],
            ...
            [ 'type' => 'radio_button_set', 'heading' => 'LR balanced split', 'param_name' => 'pattern_lr_split_mode', 'default' => 'no', 'value' => [ 'no' => 'Disabled', 'yes' => '50/50 split' ], 'group' => 'Design', 'dependency' => [ [ 'element' => 'layout_pattern', 'value' => 'alternado_lr', 'operator' => '==' ] ] ],
            ...
            // Filters
            [ 'type' => 'radio_button_set', 'heading' => 'Category filter', 'param_name' => 'category_filter_enable', 'default' => 'no', 'value' => [ 'yes' => 'Enabled', 'no' => 'Disabled' ], 'group' => 'Filters' ],
            [ 'type' => 'textfield', 'heading' => 'All tab label', 'param_name' => 'category_filter_all_label', 'default' => 'All', 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'textfield', 'heading' => 'Tabs gap', 'param_name' => 'category_filter_gap', 'default' => '12px', 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'textfield', 'heading' => 'Margin top', 'param_name' => 'category_filter_margin_top', 'default' => '0px', 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'textfield', 'heading' => 'Margin bottom', 'param_name' => 'category_filter_margin_bottom', 'default' => '20px', 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'select', 'heading' => 'Horizontal alignment', 'param_name' => 'category_filter_justify', 'default' => 'center', 'value' => [ 'flex-start' => 'Left', 'center' => 'Center', 'flex-end' => 'Right', 'space-between' => 'Space between' ], 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'select', 'heading' => 'Text alignment', 'param_name' => 'category_filter_text_align', 'default' => 'center', 'value' => [ 'left' => 'Left', 'center' => 'Center', 'right' => 'Right' ], 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'textfield', 'heading' => 'Padding', 'param_name' => 'category_filter_padding', 'default' => '', 'description' => 'E.g.: 8px 18px', 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'textfield', 'heading' => 'Border radius', 'param_name' => 'category_filter_border_radius', 'default' => '', 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'colorpickeralpha', 'heading' => 'Text color', 'param_name' => 'category_filter_text_color', 'default' => '', 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'colorpickeralpha', 'heading' => 'Active text color', 'param_name' => 'category_filter_active_text_color', 'default' => '', 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'colorpickeralpha', 'heading' => 'Background', 'param_name' => 'category_filter_background', 'default' => '', 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'colorpickeralpha', 'heading' => 'Active background', 'param_name' => 'category_filter_active_background', 'default' => '', 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'colorpickeralpha', 'heading' => 'Border color', 'param_name' => 'category_filter_border_color', 'default' => '', 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'colorpickeralpha', 'heading' => 'Active border color', 'param_name' => 'category_filter_active_border_color', 'default' => '', 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'textfield', 'heading' => 'Border width', 'param_name' => 'category_filter_border_width', 'default' => '', 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'radio_button_set', 'heading' => 'Tabs typography override', 'param_name' => 'category_filter_typography_enable', 'default' => 'no', 'value' => [ 'yes' => 'Enabled', 'no' => 'Disabled' ], 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'typography', 'heading' => 'Tabs typography', 'param_name' => 'category_filter_typography', 'remove_from_atts' => true, 'group' => 'Filters', 'choices' => [ 'font-family' => 'category_filter_font', 'variant' => 'category_filter_font', 'font-size' => 'category_filter_font_size', 'line-height' => 'category_filter_line_height', 'letter-spacing' => 'category_filter_letter_spacing' ], 'default' => [ 'font-family' => '', 'variant' => '', 'font-size' => '', 'line-height' => '', 'letter-spacing' => '' ], 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ], [ 'element' => 'category_filter_typography_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
            [ 'type' => 'radio_button_set', 'heading' => 'Tabs text transform', 'param_name' => 'category_filter_text_transform', 'default' => '', 'value' => [ '' => 'Default', 'uppercase' => 'Uppercase', 'lowercase' => 'Lowercase', 'capitalize' => 'Capitalize' ], 'group' => 'Filters', 'dependency' => [ [ 'element' => 'category_filter_enable', 'value' => 'yes', 'operator' => '==' ] ] ],
        ];
